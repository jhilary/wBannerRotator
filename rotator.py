...
if __name__=="__main__":
    ...
    if  args.blocks > len(all_banners):
        ...
        exit(1)
    if args.statistics_csv_file and len(all_banners) * args.blocks > 100:
         print "Sorry, we can't make statistics for huge number of banners. Only random banners will be shown."
         args.statistics_csv_file = None
